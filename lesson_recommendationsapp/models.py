...
class LessonRecommendation(models.Model):
    ...
    assignment             = models.ForeignKey("assignmentapp.Assignment", on_delete=models.CASCADE,related_name="lesson_recommendations")
    ...
    applied_student      = models.ForeignKey("studentapp.Student", on_delete=models.SET_NULL,null=True, blank=True,related_name="lesson_recommendations")
    applied_group        = models.ForeignKey("groupapp.Group", on_delete=models.SET_NULL,null=True, blank=True,related_name="lesson_recommendations")
